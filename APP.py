...
"""
                            ...
                            st.info("💡 Archivo contiene puntos de terreno, cunetas, juntas y pavimento")
                            
                            # Mostrar resumen de datos generados
                            with st.expander("📊 Resumen de datos AutoCAD generados"):
                                ...
                                st.write(f"**Total de puntos:** {len(points_data) + 50} (aproximado)")
                                st.write("**Capas incluidas:** Terreno, Drenaje, Juntas, Pavimento, Referencia")
